...
export default function PrimarySearchAppBar() {
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Menu
        anchorEl={leftMenuOpen}
        open={Boolean(leftMenuOpen)}
        onClose={handleLeftMenuClose} // Close the menu on clicking away
      >
        <MenuItem onClick={handleLeftMenuClose}>Hotsellers</MenuItem>
        <MenuItem onClick={handleLeftMenuClose}>New Arrivals</MenuItem>
        <MenuItem onClick={handleLeftMenuClose}>Genre</MenuItem>
        <MenuItem onClick={handleLeftMenuClose}>All Books</MenuItem>
      </Menu>
      {renderMobileMenu}
      {renderMenu}
    </Box>
